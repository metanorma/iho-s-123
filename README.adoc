image::./sources/3.0.0/images/figure-s123-logo.svg[S123_logo__signalFlagsSpellingS123,248,120]

= IHO S-123 Bathymetric Surface Product Specification

image:https://github.com/metanorma/S-123-Product-Specification/actions/workflows/generate.yml/badge.svg["Build Status", link="https://github.com/metanorma/S-123-Product-Specification/actions/workflows/generate.yml"]

This document is available in its rendered forms here:

* https://iho-ohi.github.io/S-123-Product-Specification/[IHO S-123 (HTML)]

== Purpose

This is the IHO repository for developing the next edition of
the S-123 Bathymetric Surface Product Specification.
...
This repository contains the source files of S-123 standards, including:
...
`sources/`::
source of the S-123 documents and models
